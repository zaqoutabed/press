...
def get_remove_step_statuses(job):
	...
	if job.job_type == "Archive Site":
		archive_dir_step_status = get_remove_step_status(job)
		upstream_remove_step_status = get_remove_step_status(other_job)
	elif job.job_type == "Remove Site from Upstream":
		upstream_remove_step_status = get_remove_step_status(job)
		archive_dir_step_status = get_remove_step_status(other_job)
	else:
